...
public class TessEngine {
    ...
    public String detectText(Bitmap bitmap) {
        ...
        tessBaseAPI.setVariable(TessBaseAPI.VAR_CHAR_BLACKLIST, "ABCDEFGHIJKLMNPQRTVWXY!@#$%^&*()_+=-qwertyuiop[]}{POIU" + "YTREWQasdASDfghFGHjklJKLl;L:'\"\\|~`xcvXCVbnmBNM,./<>?");

        //tessBaseAPI.setVariable(TessBaseAPI.VAR_CHAR_WHITELIST, "A0123456789CDEFGHJKLMNPQRTVWXY");
